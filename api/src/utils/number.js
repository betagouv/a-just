...
/**
 * Retourne un nombre 0 à 9 écrit en lettre
 * @param {*} nombre
 * @returns string
 */
...
/**
 * Retourne un nombre de dizaine (entre 0 et 100) écrit en lettre
 * @param {*} nombre
 * @returns string
 */
...
/**
 * Converti nombre complexe en lettre
 * @param {*} nombre
 * @returns
 */
