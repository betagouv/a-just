...
export const TEMPLATE_FORGOT_PASSWORD_ID_CA = 91

export const TEMPLATE_NEW_USER_SIGNIN = 5
export const TEMPLATE_NEW_USER_SIGNIN_CA = 94

export const TEMPLATE_CALL_ME_BACK = 72
export const TEMPLATE_USER_ONBOARDING = 3

export const TEMPLATE_USER_JURIDICTION_RIGHT_CHANGED = 8
export const TEMPLATE_USER_JURIDICTION_RIGHT_CHANGED_CA = 93

export const TEMPLATE_CRON_USERS_NOT_CONNECTED = 17

export const TEMPLATE_2_AUTH_USER_LOGIN = 64
export const TEMPLATE_2_AUTH_USER_LOGIN_CA = 95
