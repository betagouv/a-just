      ...
      helmet({
        ...
        contentSecurityPolicy: {
          directives: {
            ...
            'worker-src': ['blob:'],
            'frame-src': ['https://app.videas.fr/', 'https://docs.a-just.beta.gouv.fr', 'https://meta.a-just.beta.gouv.fr', 'https://forms-eu1.hsforms.com/', 'https://calendly.com', 'https://app-eu1.hubspot.com/'],
            'object-src': ["'self'"],
