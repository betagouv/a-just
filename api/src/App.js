      ...
      helmet({
        ...
        contentSecurityPolicy: {
          directives: {
            ...
            'default-src': ["'none'"],
            'style-src': ["'self'", ...styleSha1Generate([`${__dirname}/front/index.html`]), 'cdnjs.cloudflare.com', 'sha256-PDv7PK7p4vec7tI/1XbvDMwahytuLYN1Ul7CMcw1gHY='],
            'worker-src': ['blob:'],
            'frame-src': ['https://app.videas.fr/', 'https://docs.a-just.beta.gouv.fr', 'https://meta.a-just.beta.gouv.fr', 'https://forms-eu1.hsforms.com/', 'https://calendly.com'],
            'object-src': ["'self'"],
