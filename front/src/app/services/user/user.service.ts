...
export class UserService implements OnInit {
  ...
  /**
   * Constructor qui initialise les données de l'utilisateur courant
   */
  constructor() {
  ...
  /**
   * Initialisation des données de l'utilisateur courant
   */
  ngOnInit(): void {
  ...
  /**
   * Retourne si l'interface est CA
   * @returns
   */
  isCa() {
  ...
  /**
   * Retourne si l'interface est TJ
   * @returns
   */
  isTJ() {
