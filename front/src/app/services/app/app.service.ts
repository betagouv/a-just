...
/**
 * Toastr JS global déclaré dans le fichier angular.json
 */
...
export class AppService {
   ...
   */
  alert: BehaviorSubject<AlertInterface | null> = new BehaviorSubject<AlertInterface | null>(null)
  /**
   * Cache previous URL
   */
   ...
   * Mettre à mettre en alert
   */
  tooltipsOpenId: BehaviorSubject<string | null> = new BehaviorSubject<string | null>(null)
  /**
