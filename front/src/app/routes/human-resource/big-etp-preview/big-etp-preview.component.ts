...
import { Component, ElementRef, Input, ViewChild, OnChanges, input } from '@angular/core'
import { ETP_NEED_TO_BE_UPDATED } from '../../../constants/referentiel'
import { fixDecimal } from '../../../utils/numbers'
import { GET_COLOR, RED_COLOR } from '../../../constants/colors'
...
export class BigEtpPreviewComponent implements OnChanges {
   ...
   */
  ngOnChanges() {
    this.warningETP = this.realETP() === ETP_NEED_TO_BE_UPDATED || this.realETP() === null
