 ...
 */
@Component({
  selector: 'aj-date-select-double',
  templateUrl: './date-select-double.component.html',
  styleUrls: ['./date-select-double.component.scss'],
})
export class DateSelectDoubleComponent extends MainClass implements OnChanges {
  /**
   * Titre du bouton
   */
