import { HAS_ACCESS_TO_CONTRACTUEL, HAS_ACCESS_TO_GREFFIER, HAS_ACCESS_TO_MAGISTRAT, USER_ACCESS_ACTIVITIES, USER_ACCESS_VENTILATIONS} from "../constants/user-access";
