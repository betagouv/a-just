 ...
 * Lien de la documentation
 */
export const DOCUMENTATION_URL_CA =
 ...
 */
export const DOCUMENTATION_CREATE_NEW_PERSON =
  'https://docs.a-just.beta.gouv.fr/documentation-deploiement/ventilateur/creer-une-nouvelle-fiche';
/**
 * Lien pour modifier une fiche
 */
export const DOCUMENTATION_UPDATE_PERSON =
  'https://docs.a-just.beta.gouv.fr/documentation-deploiement/ventilateur/enregistrer-une-nouvelle-situation';
/**
...
export const HELP_CENTER_GITBOOK =
  'https://docs.a-just.beta.gouv.fr/centre-daide/';
/**
...
export const NOMENCLATURE_DROIT_LOCAL_DOWNLOAD_URL =
  '/assets/nomenclature-A-Just-droit-local';
/**
 * URL de la nomenclature CA
 */
export const NOMENCLATURE_DOWNLOAD_URL_CA =
  '/assets/nomenclature-A-Just-CA.html';
