...
export const DDG_REFERENTIELS_MAG = [
    ...
    'ASSISES JIRS', 'CONTENTIEUX JIRS', 'CONTENTIEUX DE LA DÉTENTION JIRS', 'CONTENTIEUX DU CONTRÔLE JUDICIAIRE JIRS', 'CONTENTIEUX DE FOND JIRS',
    'ASSISES HORS JIRS', 'COUR CRIMINELLE DÉPARTEMENTALE', 'CONTENTIEUX SOCIAL', 'SOUTIEN (HORS FORMATIONS SUIVIES)'
]
...
export const DDG_REFERENTIELS_EAM = [
    ...
    'ASSISES JIRS', 'CONTENTIEUX JIRS', 'CONTENTIEUX DE LA DÉTENTION JIRS', 'CONTENTIEUX DU CONTRÔLE JUDICIAIRE JIRS', 'CONTENTIEUX DE FOND JIRS',
    'ASSISES HORS JIRS', 'COUR CRIMINELLE DÉPARTEMENTALE', 'CONTENTIEUX SOCIAL', 'SOUTIEN (HORS FORMATIONS SUIVIES)',
    'FONCTIONNAIRES / JA AFFECTÉS AUX ACTIVITÉS CIVILES ET COMMERCIALES DU PARQUET GÉNÉRAL', 'ACCUEIL DU JUSTICIABLE', 'AUTRES FONCTIONNAIRES / JA AFFECTÉS AU PARQUET GÉNÉRAL'
]
