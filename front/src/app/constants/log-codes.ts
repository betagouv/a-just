/**
 * Code de démarrage du centre d'aide
 */
export const HELP_START = 400

/**
 * Code d'arrêt du centre d'aide
 */
export const HELP_STOP = 401

/**
 * Code de démarrage automatique du centre d'aide
 */
export const HELP_AUTOSTART = 402

/**
 * Code de démarrage automatique et arrêt du centre d'aide
 */
...
/**
 * Code de démarrage de la sous simulation
 */
export const ACTIVITIES_SHOW_LEVEL_4 = 502

/**
 * Code de démarrage de la calculatrice
 */
...
/**
 * Code de démarrage de la requête de l'aide
 */
