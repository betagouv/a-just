...
describe('Forgot Password Page', () => {
    ...
    it('Check that an alert is raised if the email is unknown (before the email is sent)', () => {
      ...
      cy.get('form')
         .get("input[type=email]").type('qdtpa' + user.email)
         .get("input[type=submit]").click()

      cy.get('@alert').should('have.been.calledWith', 'Information de contact non valide!')
    })
    ...
    it('check that an alert is raised if the email is not registered', () => {
      ...
      cy.get('form')
         .get("input[type=email]").type('qsdqqsdfgi' + user.email)
    ...
    it('check that an alert is raised if the password and confirmation password are differents', () => {
      ...
      cy.get('form')
         ...
         .get("input[type=text]").type(token)
         .get(".first-password").type(user.password)
         .get(".confirm-password").type(user.password + "123")
         .get("input[type=submit]").click()

      cy.get('@alert').should('have.been.calledWith', 'Vos mots de passe ne sont pas identiques');
    })
   ...
   it('check that an alert is raised if the password is too short', () => {
      ...
      cy.get('form')
         .get("input[type=email]").type(user.email)
         .get("input[type=text]").type(token)
         .get(".first-password").type("Xjq3av!")
         .get(".confirm-password").type("Xjq3av!")
         .get("input[type=submit]").click()

      cy.get('@alert').should('have.been.calledWith', 'Vous devez saisir un mot de passe qui remplit les critères obligatoires');
   })
   ...
   it('Check that an alert is raised if the password does not contain at least one special character', () => {
      ...
      cy.get('form')
         .get("input[type=email]").type(user.email)
         .get("input[type=text]").type(token)
         .get(".first-password").type("Xjq3aGvp")
         .get(".confirm-password").type("Xjq3aGvp")
         .get("input[type=submit]").click()
   ...
   it('Check that an alert is raised if the password does not contain at least one number', () => {
      ...
      cy.get('form')
         .get("input[type=email]").type(user.email)
         .get("input[type=text]").type(token)
         .get(".first-password").type("Xjq!aGvp")
         .get(".confirm-password").type("Xjq!aGvp")
         .get("input[type=submit]").click()
   ...
   it('Check that an alert is raised if the password does not contain at least one uppercase character', () => {
      ...
      cy.get('form')
         .get("input[type=email]").type(user.email)
         .get("input[type=text]").type(token)
         .get(".first-password").type("xjq31av!")
         .get(".confirm-password").type("xjq31av!")
         .get("input[type=submit]").click()
